...
class RunInput(object):
    ...
    def __init__(self, description=None, parameter_set_id=None, parameter_set=None, graph_id=None, score_id=None, receptors_id=None, terminals_id=None, exclude_id=None, include_id=None, root=None):  # noqa: E501
    ...
    @property
    def exclude_id(self):
        """Gets the exclude_id of this RunInput.  # noqa: E501

        Id of a node set of nodes to be excluded from the subgraphs   # noqa: E501

        :return: The exclude_id of this RunInput.  # noqa: E501
        :rtype: str
        """
        return self._exclude_id

    @exclude_id.setter
    def exclude_id(self, exclude_id):
    ...
    @property
    def include_id(self):
        """Gets the include_id of this RunInput.  # noqa: E501

        Id of a node set of nodes to be included in the subgraphs   # noqa: E501

        :return: The include_id of this RunInput.  # noqa: E501
        :rtype: str
        """
        return self._include_id

    @include_id.setter
    def include_id(self, include_id):
