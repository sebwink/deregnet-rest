...
class ScoreApi(object):
    ...
    def delete_score(self, score_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.delete_score(score_id, async=True)
        >>> result = thread.get()

        :param async bool
        :param str score_id: ID of the node score to be deleted (required)
        :return: None
    ...
    def delete_score_with_http_info(self, score_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.delete_score_with_http_info(score_id, async=True)
        >>> result = thread.get()
    ...
    def get_score(self, score_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_score(score_id, async=True)
        >>> result = thread.get()

        :param async bool
        :param str score_id: ID of node score to return (required)
        :return: ScoreInfo
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_score_with_http_info(self, score_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_score_with_http_info(score_id, async=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ScoreInfo',  # noqa: E501
            auth_settings=auth_settings,
            async=params.get('async'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_scores(self, **kwargs):  # noqa: E501
        """List available previously uploaded node scores  # noqa: E501

        Returns a list with all available node scores  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_scores(async=True)
        >>> result = thread.get()
    ...
    def get_scores_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_scores_with_http_info(async=True)
        >>> result = thread.get()
        ...
        if 'skip' in params and params['skip'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `skip` when calling `get_scores`, must be a value greater than or equal to `0`")  # noqa: E501
        if 'limit' in params and params['limit'] > 50:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_scores`, must be a value less than or equal to `50`")  # noqa: E501
        if 'limit' in params and params['limit'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_scores`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[ScoreInfo]',  # noqa: E501
            auth_settings=auth_settings,
            async=params.get('async'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def post_score(self, body, **kwargs):  # noqa: E501
        """Upload a node score for use with DeRegNet algorithms  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.post_score(body, async=True)
        >>> result = thread.get()

        :param async bool
        :param Score body: Node scores to be uploaded for later use with a DeRegNet algorithm (required)
        :return: ScoreInfo
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.post_score_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_score_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def post_score_with_http_info(self, body, **kwargs):  # noqa: E501
        """Upload a node score for use with DeRegNet algorithms  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.post_score_with_http_info(body, async=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_score`")  # noqa: E501
