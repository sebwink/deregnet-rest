...
export default class RunInput {
    ...
    * All data and parameters the algorithm needs / can accept to run
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('exclude_id')) {
                obj['exclude_id'] = ApiClient.convertToType(data['exclude_id'], 'String');
            }
            if (data.hasOwnProperty('include_id')) {
                obj['include_id'] = ApiClient.convertToType(data['include_id'], 'String');
            }
    ...
    */
    ...
    /**
    * Id of a node set of nodes to be excluded from the subgraphs 
    * @member {String} exclude_id
    */
    exclude_id = undefined;
    /**
    * Id of a node set of nodes to be included in the subgraphs 
    * @member {String} include_id
    */
