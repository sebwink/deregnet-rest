...
local kong = kong
local jwt_secrets_schema = kong.db.cookie_jwt_secrets.schema
local consumers_schema   = kong.db.consumers.schema


return {
  ["/consumers/:consumers/cookie-jwt/"] = {
  ...
  ["/consumers/:consumers/cookie-jwt/:jwt_secrets"] = {
    schema = jwt_secrets_schema,
    methods = {
  ...
  ["/cookie-jwts/:jwt_secrets/consumer"] = {
